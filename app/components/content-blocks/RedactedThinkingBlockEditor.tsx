    ...
    return (
        <div className="flex flex-col gap-3 bg-gray-100/40 dark:bg-gray-800/20 p-3 rounded-[var(--radius-md)] border border-gray-200/60 dark:border-gray-700/40">
            ...
            <div className="flex flex-col gap-1.5">
                ...
                <AutoResizeTextarea
                    className="w-full p-2.5 border border-[var(--input-border)] rounded-[var(--radius-sm)] text-sm font-mono bg-[var(--input-bg)] text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-gray-400/20 focus:border-gray-400 transition-all duration-[var(--transition-fast)]"
                    value={block.data}
